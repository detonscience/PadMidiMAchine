...
window_height = min(860, screen_height - 80)
window_height = max(window_height, 760)
...
musical_panel.grid(row=0, column=0, padx=8, pady=6, sticky="nsew")
...
timing_panel.grid(row=0, column=1, padx=8, pady=6, sticky="nsew")
...
expression_panel.grid(row=1, column=0, padx=8, pady=6, sticky="nsew")
...
bass_panel.grid(row=1, column=1, padx=8, pady=6, sticky="nsew")
...
output_panel.grid(row=2, column=0, padx=8, pady=6, sticky="nsew")
...
button_panel.grid(row=2, column=1, padx=8, pady=6, sticky="nsew")
...
decor_frame = tk.Frame(button_panel, bg="#151922", bd=0, highlightthickness=0)
decor_frame.grid(row=5, column=0, columnspan=2, padx=6, pady=(10, 6), sticky="nsew")
button_panel.rowconfigure(5, weight=1)

decor_canvas = tk.Canvas(
    decor_frame,
    width=240,
    height=160,
    bg="#1a202a",
...
decor_canvas.pack(fill="both", expand=True)

# Geometric logo / design
decor_canvas.create_rectangle(0, 0, 240, 160, fill="#1a202a", outline="")
decor_canvas.create_polygon(
    28, 128, 74, 38, 120, 128,
    fill="#3a86ff", outline=""
)
decor_canvas.create_polygon(
    76, 128, 122, 38, 168, 128,
    fill="#8ecae6", outline=""
)
decor_canvas.create_polygon(
    124, 128, 170, 38, 216, 128,
    fill="#7bdff2", outline=""
)

decor_canvas.create_line(28, 128, 120, 128, fill="#edf2f7", width=2)
decor_canvas.create_line(76, 128, 168, 128, fill="#edf2f7", width=2)
decor_canvas.create_line(124, 128, 216, 128, fill="#edf2f7", width=2)

decor_canvas.create_oval(105, 58, 139, 92, fill="#edf2f7", outline="")
decor_canvas.create_oval(112, 65, 132, 85, fill="#1a202a", outline="")

decor_canvas.create_text(
    120, 145,
    text="Bienvenido",
    fill="#edf2f7",
...
final_height = min(max(required_height, 760), screen_height - 40)
final_width = min(max(required_width, window_width), screen_width - 40)
